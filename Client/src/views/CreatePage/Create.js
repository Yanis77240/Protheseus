					...
					<Fade in={true} timeout={{ enter: 900 }}>
						<Card className={classes.formCard} elevation={5}>
							...
							<Typography variant="h6" gutterBottom>
									Créez votre guide doigts
							</Typography>
							<div style={{display:'flex',flexDirection:'row', alignItems:'flex-start', marginBottom: "5px",marginTop: "5px"}}>
								<div>
									<TextField placeholder='Ex : iPad Pro' id="outlined-basic" value={caract.device} onChange={(e)=>setcaract({...caract, device:e.target.value})} style={{ marginRight:'5px' }} label="Appareil" variant="outlined" />
								</div>
								<div>
									<TextField placeholder='Ex : Grid 3 5x5' id="outlined-basic" value={caract.application} onChange={(e)=>setcaract({...caract, application:e.target.value})} style={{marginLeft:'5px', minWidth:'220px' }} label="Application de CAA et Grille" variant="outlined" />
								</div>
							</div>
								...
								>
									...
									<FormControlLabel
										...
										label="Télécharger sans publier"
									/>
									<Button
										disabled={!switchAvance}
										variant="contained"
